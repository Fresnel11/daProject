...
exports.InitialMigration1751721545441 = void 0;
class InitialMigration1751721545441 {
    constructor() {
        this.name = 'InitialMigration1751721545441';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`roles\` (\`id\` varchar(36) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`school_id\` varchar(255) NOT NULL, \`is_system_role\` tinyint NOT NULL DEFAULT 0, \`is_active\` tinyint NOT NULL DEFAULT 1, UNIQUE INDEX \`IDX_162b4502fd9fb2b641cea72fec\` (\`name\`, \`school_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
...
exports.InitialMigration1751721545441 = InitialMigration1751721545441;
//# sourceMappingURL=1751721545441-InitialMigration.js.map